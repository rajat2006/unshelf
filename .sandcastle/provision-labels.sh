...
labels=(
  ...
  "agent:codex|8250df|Provider (optional): pin this issue to Codex, whatever the default provider is"
  ...
  "agent:update-branch|5319e7|Trigger: refresh this stale PR branch against its base"
