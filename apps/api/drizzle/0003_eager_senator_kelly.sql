...
ALTER TABLE "stage_items" ADD CONSTRAINT "stage_items_placement_fk" FOREIGN KEY ("placement_id","user_id","learning_plan_id") REFERENCES "public"."learning_plan_item_placements"("id","user_id","learning_plan_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
