...
/**
 * A small circular progress meter — a Stage's *done* Items over its total, drawn
 ...
 * colours and sizes it to its own world; here the LearningPlan's waypoints fill it.
 */
