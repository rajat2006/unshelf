...
/** Below this width the LearningPlan is viewed, not authored (US 40, ADR-0008). */
const PHONE_MAX_WIDTH = "(max-width: 640px)";

/**
 * Whether the viewport is phone-width. The LearningPlan is authored on desktop and only
