...
15–30 min run is $0.12–0.24). The four Product-CI-owning capabilities allow 120
minutes ($0.96 worst case) so polling and bounded recovery stay in the active call;
other agent jobs retain their existing ceilings.
